 ...
 */
final class Version20220105212749 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, entreprises_id INT NOT NULL, titre VARCHAR(100) NOT NULL, mission LONGTEXT NOT NULL, email VARCHAR(100) NOT NULL, INDEX IDX_C27C9369A70A18EC (entreprises_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
